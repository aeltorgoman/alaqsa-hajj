...
export const LIMITS = {
  ...
  /* واتساب: **رسالة واحدة لكل استدعاء**، والإرسال الجماعيّ حلقةٌ في
     المتصفّح — فالحدّ يُحسب بالرسائل لا بالدفعات. حملة من ٣٠٠ حاجّ
     بنصٍّ ومستندَين تبلغ ٩٠٠ رسالة، والسقف فوق ذلك بهامش يسمح
     بإعادة إرسال دفعة فاشلة في الساعة نفسها. وهو يقطع الحلقة
     المنفلتة قبل أن تصير فاتورةً على الحملة أو حظراً من Meta */
  whatsappSend: { scope: "whatsapp-send", limit: 1200, windowSeconds: 3600 },
