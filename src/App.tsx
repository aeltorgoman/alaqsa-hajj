    ...
    reader.onload = async (e) => {
      ...
      try {
        const res = await fetch("https://api.anthropic.com/v1/messages", {
          ...
          body: JSON.stringify({ model: "claude-sonnet-4-0", max_tokens: 1000, messages: [{ role: "user", content: [{ type: "image", source: { type: "base64", media_type: file.type, data: base64 } }, { type: "text", text: `استخرج بيانات جواز السفر وأجب فقط بـ JSON: {"name_en":"","name_ar":"","short_en":"","short_ar":"","passport":"","national_id":"الرقم الشخصي من الجواز القطري أو المصري","nationality":"","dob":"","expiry":"","gender":"ذكر أو أنثى"}` }] }] })
        });
