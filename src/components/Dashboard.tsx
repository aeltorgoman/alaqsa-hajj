    ...
    <div style={{ display:"flex", flexDirection:"column", height:"100%", overflow:"hidden" }}>
      ...
      <div style={{ position:"relative", flexShrink:0, height:240 }}>
        ...
        <div style={{
          ...
          background: `linear-gradient(110deg, ${primary}f0 0%, ${primary} 50%, ${primary}cc 100%)`,
          overflow:"hidden",
        }}>
          {/* نقوش */}
          ...
          <div style={{ position:"absolute", top:14, left:16, display:"flex", alignItems:"center", gap:8, zIndex:5 }}>
        ...
        {/* ===== كروت الإحصاء — متداخلة في أسفل البانر ===== */}
        <div style={{
          ...
          {statCards.map(({ label, num, sub, bg, shadow, icon }) => (
            <div key={label} style={{ borderRadius:16, padding:"16px 20px", color:"#fff", background:bg, boxShadow:`0 8px 28px ${shadow}`, border:"1.5px solid rgba(255,255,255,0.12)", backdropFilter:"blur(4px)" }}>
              ...
              <div style={{ fontSize:36, fontWeight:900, lineHeight:1, marginBottom:4 }}>{num}</div>
      ...
      {/* ==================== BODY (تحت البانر) ==================== */}
      <div style={{ flex:1, display:"flex", gap:12, overflow:"hidden", padding:"52px 14px 14px" }}>
